...
class SHA1AlgorithmScreen extends StatefulWidget {
  const SHA1AlgorithmScreen({super.key});

  @override
  State<SHA1AlgorithmScreen> createState() => _SHA1AlgorithmScreenState();
}

class _SHA1AlgorithmScreenState extends State<SHA1AlgorithmScreen> {
  var cipher = Sha_1();
